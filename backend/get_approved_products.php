<?php
/**
 * Get all approved products (alias for get_products.php)
 * Returns JSON with approved products including images
...
try {
    ...
    $sql = "SELECT 
                ...
                p.user_id,
                p.created_at,
                GROUP_CONCAT(pi.image_name ORDER BY pi.id SEPARATOR ',') as images
            FROM products p
